...
import CodeComposerSett from "./CodeComposerSett";
import "./MainComposeView.css";

class MainComposeView extends React.Component {
  constructor() {
    super();
    ...
    //binging all the responses from the user
